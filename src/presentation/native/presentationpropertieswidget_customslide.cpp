...
PresentationPropertiesWidget_CustomSlide::PresentationPropertiesWidget_CustomSlide(const QSharedPointer<Presentation_CustomSlide> &presentation, QWidget *parent) : QWidget(parent),
