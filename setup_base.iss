...
[Types]
Name: "full"; Description: "Nepřenosná instalace"
Name: "portable"; Description: "Portable/přenosná instalace"

[Components]
Name: "core"; Description: "Aplikace"; Types: full portable; Flags: fixed
Name: "portable"; Description: "Portable/přenosný mód (data programu se ukládají do složky s aplikací)"; Types: portable
...
begin
  ...
  try
    ...
    then
      MsgBox('Nepodařilo se spustit instalátor MSVC Redist. Aplikace bez této knihovny nemusí fungovat.' + #13#10 + SysErrorMessage(ResultCode), mbError, MB_OK);
  finally
...
begin
  ...
  try
    ...
    then
      MsgBox('Nepodařilo se spustit instalátor K-Lite. Bez těchto kodeků nemusí fungovat funkce přehrávače videí.' + #13#10 + SysErrorMessage(ResultCode), mbError, MB_OK);
  finally
    WizardForm.StatusLabel.Caption := StatusText;
    WizardForm.ProgressGauge.Style := npbstNormal;
  end;
